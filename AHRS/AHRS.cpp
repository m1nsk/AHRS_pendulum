...
std::unique_ptr<InertialSensor> AHRS::getInertialSensor(string sensor_name)
{
    if (sensor_name == "mpu") {
...
int main1(int argc, char *argv[])
{
    ...
    if (!imu) {
        printf("Wrong sensor name. Select: mpu or 6050 or lsm\n");
        return EXIT_FAILURE;
    }
